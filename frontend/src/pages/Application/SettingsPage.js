...
export default function SettingsDropdown({}) {
  ...
  const list = (anchor) => (
    ...
    <Box
        ...
        >
            <button
                className={`${value === '0' ? 'bg-[#8BEDF3]' : 'bg-[#c1f2f5]'} 
                px-4 py-6 text-base font-semibold font-['system-ui'] rounded-r-lg
                shadow-inner shadow-[#8BEDF3]/30 flex flex-row items-center`}
            ...
            <button
                className={`${value === '1' ? 'bg-[#8BEDF3]' : 'bg-[#c1f2f5]'} 
                px-4 py-6 text-base font-semibold font-['system-ui'] rounded-r-lg
                shadow-inner shadow-[#8BEDF3]/30 flex flex-row items-center`}
            ...
            <button
                className={`${value === '2' ? 'bg-[#8BEDF3]' : 'bg-[#c1f2f5]'} 
                px-4 py-6 text-base font-semibold font-['system-ui'] rounded-r-lg
